...
```{r Statistical Test Round 2}
BeforeRegression2<-lm(MilburnieDam_AllSites_DOTemp_Before_range$AvgDO~MilburnieDam_AllSites_DOTemp_Before_range$AvgT)
...
cor.test(MilburnieDam_AllSites_DOTemp_Before_range$AvgDO, MilburnieDam_AllSites_DOTemp_Before_range$AvgT)
#Results:
...
```{r After}
AfterRegression2<-lm(MilburnieDam_AllSites_DOTemp_After_range$AvgDO~MilburnieDam_AllSites_DOTemp_After_range$AvgT)
...
cor.test(MilburnieDam_AllSites_DOTemp_After_range$AvgDO, MilburnieDam_AllSites_DOTemp_After_range$AvgT)
#Results:
